...
marker = Marker()
marker.header.frame_id = 'rs200_camera'
marker.ns = "marker"
...
def face_cords_callback(data):
    ...
    marker.header.stamp = rospy.Time.now()
    marker.pose.position.x = data.x_p2/1000
    marker.pose.position.y = data.y_p2/1000
    marker.pose.position.z = data.z_p2/1000
    marker.color.r = 0.0
    marker.color.g = 1.0
    marker.color.b = 0.5
    marker.id = 1
...
def bowl_cords_callback(data):
    ...
    marker.header.stamp = rospy.Time.now()
    marker.pose.position.x = data.data[0]/1000
    marker.pose.position.y = data.data[1]/1000
    marker.pose.position.z = data.data[2]/1000
    marker.color.r = 1.0
    marker.color.g = 0.0
    marker.color.b = 0.0
    marker.id = 2
